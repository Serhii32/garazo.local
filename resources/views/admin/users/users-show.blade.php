        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12 col-md-9 p-2">
                ...
                <div class="py-4 bg-white border rounded border-light shadow">
                    <h2 class="text-center font-weight-bold text-uppercase pb-5">Заказы пользователя</h2>
                    <div class="container-fluid">
                        <div class="row">
                                ...
                                @foreach($orders as $order)
                                    <div class="row my-3 h-100 shadow p-2">
                                        <div class="col-12 col-md-9">
                                            <h4 class="text-left text-uppercase text-danger">@if($order->status == 1)Новый заказ @elseif($order->status == 2)Выполняется @elseif($order->status == 3)Выполнен @else @endif</h4>
