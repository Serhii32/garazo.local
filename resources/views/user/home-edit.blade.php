        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12 col-md-9 p-2">
                ...
                <div class="py-4 bg-white border rounded border-light shadow">
                    {!! Form::open(['route'=>'user.home.update', 'method' => 'put', 'class' => 'py-4', 'files' => true]) !!}
                        <h2 class="text-center font-weight-bold text-uppercase pb-5">Настройки профиля</h2>
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div class="text-center">
                                        <img class="img-thumbnail img-fluid" src="{{$user->avatar ? asset($user->avatar) : asset('img/common/avatars/default.png')}}" alt="{{ $user->name }}">
                                    </div>
                                    <div class="form-group py-4">
                                        {!! Form::label('avatar', 'Выбрать фото пользователя:', ['class' => 'text-uppercase font-weight-bold']) !!}
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('name', old('name') ? :$user->name, ['placeholder'=>'Имя'] + ($errors->has('name') ? ['class'=>'form-control is-invalid'] : ['class'=>'form-control'])) !!}
                                        <span class="text-danger">{{ $errors->first('name') }}</span>
                                    </div>
                                    <div class="form-group">
                                        {!! Form::label('email', 'Email:', ['class' => 'text-uppercase font-weight-bold']) !!}
                                        {!! Form::email('email', old('email') ? old('email') :$user->email, ['placeholder'=>'Email'] + ($errors->has('email') ? ['class'=>'form-control is-invalid'] : ['class'=>'form-control'])) !!}
