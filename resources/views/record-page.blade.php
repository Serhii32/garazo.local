		...
		<div class="container">
			<div class="row">
				...
				<div class="col-12 col-md-8 col-lg-9">
					...
					<div class="text-dark font-weight-bold text-uppercase">{{ Breadcrumbs::render('page.record', $record) }}</div>

					<div class="container">
                        <div class="my-3 card h-100 shadow p-2">
                            <img class="img-fluid" src="{{$record->main_photo ? asset($record->main_photo) : asset('img/common/default.png')}}" alt="{{ $record->title }}">
                        </div>
                        <div class="my-3">
